 ...
 */
public final class ErrorLogOld {
    private BufferedWriter bw = null;
	private static ErrorLogOld errorLogger;
    ...
    public void closeErrorLog() {
        ...
        try {
            ...
            ErrorLogOld.getLogger().writeToLog(e);
     ...
     */
	public static ErrorLogOld getLogger() {
		if (errorLogger == null) errorLogger = new ErrorLogOld();
		return errorLogger;
	}
}
